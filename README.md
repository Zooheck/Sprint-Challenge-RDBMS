...
1. RDMS create tables where we can organize data based on various attributes. SQL manages arrays of resources.

2. Why do tables need a primary key?
2. This is the value by which other tables can reference the table.
